                ...
                <div className="space-y-4">
                  <div className="flex justify-between items-end">
                    <div>
                      ...
                      <p className="text-xs text-zinc-500">12 of 20 projects used</p>
                    </div>
                    <p className="text-sm font-bold text-zinc-900 dark:text-white">60%</p>
                  </div>
                ...
                <div className="space-y-4">
                  <div className="flex justify-between items-end">
                    <div>
                      ...
                      <p className="text-xs text-zinc-500">8 of 15 seats occupied</p>
                    </div>
                    <p className="text-sm font-bold text-zinc-900 dark:text-white">53%</p>
                  </div>
                  <div className="h-2 bg-zinc-100 dark:bg-zinc-800 rounded-full overflow-hidden">
